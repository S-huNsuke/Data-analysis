...
def data_wash():
    ...
    return df_week, script_dir, output_dir
df_week, script_dir, output_dir = data_wash()
...
def plt_week(df, dir_path):
    ...
    print('图片已保存为 weather_trend.png')
    plt.show()
plt_week(df_week, output_dir)
...
def weather_pie(df, dir_path):
    ...
    print('饼图已保存为 weather_pie.png')
    plt.show()
weather_pie(df_week, output_dir)
