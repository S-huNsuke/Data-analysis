...
def data_wash():
    ...
    return hourly_data, script_dir, output_dir
#绘制温度变化折线图
def plt_hourly_temp():
    hourly_data, script_dir, output_dir = data_wash()
    ...
    plt.savefig(os.path.join(output_dir, '24weather_trend.png'), dpi=300, bbox_inches='tight')
    print(f'图片已保存为 {os.path.join(output_dir, "24weather_trend.png")}')
    plt.show()
plt_hourly_temp()
#绘制湿度变化折线图
def plt_hourly_humidity():
    ...
    plt.savefig(os.path.join(output_dir, '24hourly_hum_trend.png'), dpi=300, bbox_inches='tight')
    print(f'图片已保存为 {os.path.join(output_dir, "24hourly_hum_trend.png")}')
    plt.show()
plt_hourly_humidity()
#绘制24小时风力变化雷达图
...
def wind_radar(df, dir_path):
    ...
    print('雷达图已保存为 wind_radar.png')
    plt.show()
def plt_hourly_wind():
    hourly_data, script_dir, output_dir = data_wash()
    wind_radar(hourly_data, output_dir)
plt_hourly_wind()
#绘制24小时温湿度相关性
def temp_hum(df, dir_path):
    ...
    print('温湿度相关性图已保存为 24hourly_temp_hum.png')
    plt.show()
def plt_hourly_temp_hum():
    hourly_data, script_dir, output_dir = data_wash()
    temp_hum(hourly_data, output_dir)
plt_hourly_temp_hum()
