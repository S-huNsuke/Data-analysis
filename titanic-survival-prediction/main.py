...
def visualize_survival_rate(data):
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(OUTPUT_DIR, 'survival_rate.png'), dpi=150)
    plt.show()
...
def analyze_by_gender(data):
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(OUTPUT_DIR, 'survival_by_gender.png'), dpi=150)
    plt.show()
...
def analyze_by_pclass(data):
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(OUTPUT_DIR, 'survival_by_pclass.png'), dpi=150)
    plt.show()
...
def analyze_pclass_gender(data):
    ...
    plt.savefig(os.path.join(OUTPUT_DIR, 'survival_pclass_gender.png'), dpi=150)
    plt.show()
...
def analyze_age(data):
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(OUTPUT_DIR, 'survival_by_age.png'), dpi=150)
    plt.show()
...
def analyze_embarked(data):
    ...
    plt.savefig(os.path.join(OUTPUT_DIR, 'survival_by_embarked.png'), dpi=150)
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(OUTPUT_DIR, 'embarked_analysis.png'), dpi=150)
    plt.show()

    sns.factorplot('Pclass', 'Survived', hue='Sex', col='Embarked', data=data)
    plt.savefig(os.path.join(OUTPUT_DIR, 'survival_pclass_gender_embarked.png'), dpi=150)
    plt.show()
...
def analyze_family_size(data):
    ...
    plt.close(2)
    plt.tight_layout()
    plt.savefig(os.path.join(OUTPUT_DIR, 'survival_by_sibsp.png'), dpi=150)
    plt.show()
    ...
    plt.close(3)
    plt.tight_layout()
    plt.savefig(os.path.join(OUTPUT_DIR, 'survival_family_alone.png'), dpi=150)
    plt.show()

    sns.factorplot('Alone', 'Survived', data=data, hue='Sex', col='Pclass')
    plt.savefig(os.path.join(OUTPUT_DIR, 'survival_alone_gender_pclass.png'), dpi=150)
    plt.show()
...
def create_age_bands(data):
    ...
    plt.savefig(os.path.join(OUTPUT_DIR, 'survival_age_band_pclass.png'), dpi=150)
    plt.show()
...
def create_fare_categories(data):
    ...
    plt.savefig(os.path.join(OUTPUT_DIR, 'survival_fare_category.png'), dpi=150)
    plt.show()
...
def evaluate_knn_different_k(train_X, train_Y, test_X, test_Y):
    ...
    plt.savefig(os.path.join(OUTPUT_DIR, 'knn_k_selection.png'), dpi=150)
    plt.show()
...
def cross_validate_models(X, Y):
    ...
    box.T.boxplot()
    plt.savefig(os.path.join(OUTPUT_DIR, 'model_comparison_boxplot.png'), dpi=150)
    plt.show()
...
def plot_adaboost_confusion_matrix(X, Y):
    ...
    plt.savefig(os.path.join(OUTPUT_DIR, 'adaboost_confusion_matrix.png'), dpi=150)
    plt.show()
